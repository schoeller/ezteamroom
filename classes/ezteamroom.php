...
class eZTeamroom
{
    ...
    public static function getRoomIdentifierList()
    {
        ...
        if ( $teamroomIni->hasVariable( 'TeamroomSettings', 'RoomIdentifiersMap' ) )
        {
            return $teamroomIni->variable( 'TeamroomSettings', 'RoomIdentifiersMap' );
        }
        else
        {
            eZDebug::writeWarning( 'No setting RoomIdentifiersMap in block TeamroomSettings of teamroom.ini', __METHOD__ );
        }
        return array();
    }
